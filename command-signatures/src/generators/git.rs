...
use warp_completion_metadata::{
    ...
    GeneratorResultsCollector, IconType, Importance, Order, PriorityV1, Suggestion,
};
    ...
    output
        ...
        .map(|file| {
            Suggestion::with_description(file, "Changed file")
                .with_priority(PriorityV1::Global(Importance::More(Order(100))))
...
mod tests {
    ...
    use warp_completion_metadata::{
        GeneratorResults, IconType, Importance, Order, PriorityV1, Suggestion,
    };
            ...
            GeneratorResults {
                suggestions: vec![
                    Suggestion {
                        ...
                        priority: PriorityV1::Global(Importance::More(Order(100))),
                        icon: Some(IconType::File),
                        is_hidden: false,
                    },
                    Suggestion {
